class Dwarf extends Entity { //The heroic dwarves are controlled by the player. This will be abstract someday.
  ...
  public Dwarf(int Xpos, int Ypos, String name) {
    ...
    this.name = name;
    super.ability = new Ability(1, 1, 1); //Initialize our basic dwarf with a 1 damage radial(1) attack.
    AbilityBtn btn = new AbilityBtn(50*globalTileCountX, 400, true, super.ability);
